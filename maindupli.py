...
def main():
    ...
    if args.evaluate_only:
        ...
        # Evaluate directly
        val_metrics, top1, top5 = evaluate(
            val_loader, model, criterion, 0, [0], timer(), log
        )
        # print(
        #     f"\n\n Avg. mAP: {val_metrics * 100}%, Avg. Acc1: {top1 * 100}%, Avg. Acc5: {top5 * 100}%\n"
        # )
        # print(f'\n{"mAP":<5}: {val_metrics:7.3f}')
        # print(f'{"Acc1":<5}: {top1:7.3f}')
        # print(f'{"Acc5":<5}: {top5:7.3f}')

        log.write(f'\n\n{"mAP":<5}: {val_metrics * 100:7.2f}%')
        log.write(f'\n{"Acc1":<5}: {top1 * 100:7.2f}%')
        log.write(f'\n{"Acc5":<5}: {top5 * 100:7.2f}%')
        ...
        for epoch in range(args.epochs):
            ...
            val_metrics = evaluate(
                val_loader, model, criterion, epoch, train_metrics, start, log
            )
